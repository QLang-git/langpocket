...
class SpellingSingleWordDialog extends StatelessWidget {
  final Function activateExamples;
  final Function reload;
  final String word;
  const SpellingSingleWordDialog(
      {super.key,
      required this.word,
...
//! complete example
class SpellingSingleWordExampleDialog extends StatelessWidget {
  final Function activateExamples;
  final Function reload;

  const SpellingSingleWordExampleDialog(
