...
class PronGroupWordDialog extends StatelessWidget {
  final Function activateExamples;
  final Function? moveNext;
  final String word;
  const PronGroupWordDialog(
      {super.key,
      required this.word,
...
//! complete example
class PronGroupWordExampleDialog extends StatelessWidget {
  final Function activateExamples;
  final Function reload;

  const PronGroupWordExampleDialog(
