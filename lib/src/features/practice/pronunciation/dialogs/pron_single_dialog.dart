...
class PronSingleWordDialog extends StatelessWidget {
  final Function activateExamples;
  final Function reload;
  final String word;
  const PronSingleWordDialog(
      {super.key,
      required this.word,
  ...
  Widget build(BuildContext context) {
    return ResponsiveCenter(
      child: FractionallySizedBox(
        heightFactor: 0.70, // take up 78% of screen height
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        flex: 3,
                                        child: Text(
                                          'Pronounce this word with sentences ',
...
//! complete example
class PronSingleWordExampleDialog extends StatelessWidget {
  final Function activateExamples;
  final Function reload;

  const PronSingleWordExampleDialog(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        flex: 3,
                                        child: Text(
                                          'Pronounce with sentences again',
                                          style: Theme.of(context)
                                              .textTheme
                                              .labelMedium!
                                              .copyWith(color: Colors.white),
