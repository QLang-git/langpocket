...
class Word extends amplify_core.Model {
  ...
  const Word._internal({required this.id, group, required foreignWord, required wordMeans, required wordImages, required wordExamples, required wordNote, creatingTime, updatedAt, groupWordsId, wordGroupId}): _group = group, _foreignWord = foreignWord, _wordMeans = wordMeans, _wordImages = wordImages, _wordExamples = wordExamples, _wordNote = wordNote, _creatingTime = creatingTime, _updatedAt = updatedAt, _groupWordsId = groupWordsId, _wordGroupId = wordGroupId;
  
  factory Word({String? id, Group? group, required String foreignWord, required List<String> wordMeans, required List<String> wordImages, required List<String> wordExamples, required String wordNote, String? groupWordsId, String? wordGroupId}) {
  ...
  Word copyWith({Group? group, String? foreignWord, List<String>? wordMeans, List<String>? wordImages, List<String>? wordExamples, String? wordNote, String? groupWordsId, String? wordGroupId}) {
    return Word._internal(
      id: id,
  ...
  Word copyWithModelFieldValues({
    ...
    return Word._internal(
      ...
      groupWordsId: groupWordsId == null ? this.groupWordsId : groupWordsId.value,
      wordGroupId: wordGroupId == null ? this.wordGroupId : wordGroupId.value
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'group': _group?.toJson(), 'foreignWord': _foreignWord, 'wordMeans': _wordMeans, 'wordImages': _wordImages, 'wordExamples': _wordExamples, 'wordNote': _wordNote, 'creatingTime': _creatingTime?.format(), 'updatedAt': _updatedAt?.format(), 'groupWordsId': _groupWordsId, 'wordGroupId': _wordGroupId
  };
  ...
  static final GROUPWORDSID = amplify_core.QueryField(fieldName: "groupWordsId");
